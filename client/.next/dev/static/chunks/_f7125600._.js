...
_s(UiProvider, "ByN1rIUf2q2zQVPhs8oOZOdkwfg=");
_c = UiProvider;
function useUi() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(UiContext);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeProvider.useEffect": ()=>{
            ...
            if (theme === "system") {
                ...
                const applySystem = {
                    "ThemeProvider.useEffect.applySystem": ()=>{
                        systemDark.matches ? root.classList.add("dark") : root.classList.remove("dark");
                    }
                }["ThemeProvider.useEffect.applySystem"];
                applySystem();
                systemDark.addEventListener("change", applySystem);
                return ({
                    "ThemeProvider.useEffect": ()=>systemDark.removeEventListener("change", applySystem)
                })["ThemeProvider.useEffect"];
            }
        }
    }["ThemeProvider.useEffect"], [
...
_s(ThemeProvider, "tdAdW/zQ5g+jE9tr73F1XiMRZgs=");
_c = ThemeProvider;
const useTheme = ()=>{
    _s1();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LenisProvider.useEffect": ()=>{
            const lenis = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lenis$2f$dist$2f$lenis$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]({
                duration: 1.2,
                easing: {
                    "LenisProvider.useEffect": (t)=>1 - Math.pow(2, -10 * t)
                }["LenisProvider.useEffect"],
                wheelMultiplier: 1,
                touchMultiplier: 1.5,
                infinite: false
...
function ChatContextProvider({ children }) {
    _s();
    const [conversationId, setConversationIdState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [messages, setMessagesState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const API = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.API || "http://localhost:1571/api";
    ...
    const loadConversation = (id, msgs)=>{
    ...
    const refreshHistory = async ()=>{
        try {
            ...
            const url = gid ? `${API}/conversations?guestId=${encodeURIComponent(gid)}` : `${API}/conversations`;
...
_s(ChatContextProvider, "0byilEdfJT6iXib4UpzJtYZJRb0=");
...
//# sourceMappingURL=_f7125600._.js.map